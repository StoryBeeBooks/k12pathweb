...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="sticky top-0 z-40 bg-white/95 backdrop-blur-sm border-b border-slate-100 py-2 px-4 shadow-sm">
      ...
      {/* Target Audience & User Type Info - NOT sticky, scrolls with page */}
